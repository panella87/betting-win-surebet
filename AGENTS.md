...
6. `PROJECT_STATUS.md` and `README.md`.
7. `docs/MASTER_PLAN.md` and the completed B1 authority documents.
8. Completed full-platform/B1 ledgers and retained implementation maps.
9. Domain, operations and recovery contracts.
10. Historical SURE ledgers, completed blueprints and legacy research.
