...
SCRIPT_VERSION="2026-07-17.surebet-v10-paper-runtime-policy"
...
write_final_summary() {
  ...
  mkdir -p "$AUTOMATION_RUN_DIR/final"
  {
    ...
    printf 'runtime_environment_loader=%s\n' 'selective_root_wrapper_env'
    printf 'runtime_environment_precedence=%s\n' 'explicit_process_then_dotenv_fill'
    printf 'runtime_schedule_loader=%s\n' 'operator_approved_repo_local_manifest'
    printf 'runtime_policy_enforcement=%s\n' 'api_paper_provider_disabled_execution_false'
    printf 'runtime_retired_input_scrub=%s\n' 'export_selectors_and_pinned_bundle'
