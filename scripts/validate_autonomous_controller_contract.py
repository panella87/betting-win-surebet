...
REQUIRED_FRAGMENTS = {
    ...
    '.automation/lib/controller_hardening_v2.sh': [
        ...
        'process remains alive after verified KILL escalation',
    ],
    ...
    'run-bugfix-autopilot.sh': [
        ...
        'automation_v2_lock_mtime_epoch "$LOCK_FILE"',
    ...
    'docs/automation/bugfix-autopilot.md': [
        ...
        'boundary_and_input_contracts',
        'cross_area_regression_and_campaign_closure',
        'atomically claims a fully formed lock',
        'BUGFIX_AUTOPILOT_BLOCKED_CHILD_IDENTITY',
        'BUGFIX_AUTOPILOT_BLOCKED_LOCK_RELEASE',
        'child_cleanup_status',
        'lock_release_status',
        'lock file modification time',
        'never rewrites the full lock env record',
        'no providers',
    ...
    'docs/automation/paper-autopilot.md': [
        ...
        'atomically hard-links it into place',
        'lock file modification time',
        'does not rewrite the full env record',
        'PAPER_AUTOPILOT_BLOCKED_CHILD_IDENTITY',
        'PAPER_AUTOPILOT_BLOCKED_LOCK_RELEASE',
        'no-service',
    ],
