...
REQUIRED_FRAGMENTS = {
    ...
    'check_progress.sh': [
        ...
        'final-summary.md',
        'cycles/cycle_',
        'bws-root-wrapper-runtime.mjs runtime-summary',
    ],
    'watch_progress.sh': [
        '--once',
        '--fast',
    ...
    'start.sh': [
        ...
        'bws-root-wrapper-runtime.mjs start',
    ],
    'stop.sh': [
        'Node is missing. Activate the repo runtime first',
        'bws-root-wrapper-runtime.mjs stop',
    ],
    ...
    '.automation/lib/controller_hardening_v2.sh': [
        ...
        'legacy parent result compatibility',
        'a child result without a run directory must be an explicit pre-start setup failure',
    ...
    '.automation/lib/run_common.sh': [
        ...
        'artifact_cleanup_repro_symlinks_selected=',
        'kind=autonomous_cycle_repro_symlink',
        ...
        'One-generation hot-upgrade compatibility',
        'AUTOMATION_PARENT_LOCK_FILE',
    ...
    'run-autonomous-bugfix.sh': [
        ...
        'not_required_for_terminal_audit_handoff',
        'bugfix_terminal_handoff_validated_before_post_codex_validation',
        'post_codex_validation=deferred_to_implementation_handoff',
    ...
    'run-paper-evaluation.sh': [
        ...
        'automation_run_argv_command "runtime_evidence" "$RUNTIME_EVIDENCE_COMMAND_TIMEOUT_SECONDS"',
    ...
    'run-bugfix-autopilot.sh': [
        ...
        'clean audit NEXT_AUDIT_AREA mismatch: expected %s or none, got %s',
...
FORBIDDEN_FRAGMENTS = {
    ...
    'run-autonomous-implementation.sh': [
        ...
        'protected_changes_allowed=manual_explicit_override',
    ],
    'run-autonomous-bugfix.sh': [
        'scripts/load-node-runtime.sh',
        'source "$HOME/.nvm/nvm.sh"',
