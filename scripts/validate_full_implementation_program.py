...
EXPECTED_STATUS = {
    'BWS-000': 'VALIDATED',
    **{task_id: 'PENDING' for task_id in EXPECTED_IDS[1:19]},
    'BWS-600': 'BLOCKED',
    'BWS-900': 'PARKED',
}
EXPECTED_DEPS = {
...
def main() -> None:
    ...
    if ready != ['BWS-100']:
        fail(f'first dependency-ready implementation task must be BWS-100, found {ready!r}')
    ...
    for marker in [
        'current_task=BWS-100', 'backlog/bws_full_implementation.csv',
