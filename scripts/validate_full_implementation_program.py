...
VALIDATED_IDS = {
    ...
    'BWS-560', 'BWS-570', 'BWS-580', 'BWS-581', 'BWS-582', 'BWS-583',
    'BWS-584', 'BWS-585', 'BWS-586', 'BWS-587', 'BWS-588', 'BWS-589',
    'BWS-590', 'BWS-591', 'BWS-592', 'BWS-593', 'BWS-599',
}
PENDING_IDS = set()
EXPECTED_STATUS = {
...
def main() -> None:
    ...
    if ready:
        fail(f'no dependency-ready safe local pending task should remain, found {ready!r}')
    ...
    for marker in [
        'status=B1_IMPLEMENTATION_READY', 'current_task=BWS-700',
        'current_task_status=READY_FOR_IMPLEMENTATION', 'safe_local_terminal_gate=BWS-599',
