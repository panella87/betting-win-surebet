...
def main() -> None:
    required = {
        ...
        'docs/repo_status_current.md': [
            PROGRAM, 'status=IMPLEMENTATION_READY', 'current_task=BWS-581',
        ...
        'docs/012_runbook.md': [
            'run-autonomous-implementation.sh', 'BWS-581', 'BWS-599', 'run-paper-autopilot.sh',
        ],
        'docs/018_private_paper_mode_runbook.md': [
            'current_stage=operator_runtime_implementation', 'BWS-581', 'BWS-599', 'BWS-600',
        ],
    }
