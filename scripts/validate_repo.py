...
def main() -> None:
    ...
    required_doc_markers = {
        ...
        'docs/automation/README.md': ['current_task=BWS-600', 'selected_controller=run-paper-autopilot.sh', 'safe_local_terminal_gate=BWS-599', 'Exact protected-file policy', 'automation_maintenance_allowed=no', 'blanket manual override is disabled', 'repository-temp-inode-safety.md'],
