...
REQUIRED = [
  ...
  'start.sh','stop.sh','check_progress.sh','watch_progress.sh','open_log.sh','update_git.sh','pull_artifacts_and_zip_codebase.sh','zip_codebase.sh','run-autonomous-implementation.sh','run-paper-evaluation.sh','run-autonomous-bugfix.sh','automation.config.sh','.automation/lib/run_common.sh',
...
def main() -> None:
    ...
    required_doc_markers = {
        ...
        'docs/automation/repo-profile.md': ['repo_role=surebet_strategy_execution_repo', 'SURE-002B_PRIVATE_PAPER_MODE_INTAKE'],
