...
def main() -> None:
    ...
    required_doc_markers = {
        'README.md': ['program=BWS_FULL_PLATFORM_IMPLEMENTATION_V1', 'repo_role=surebet_strategy_application', 'current_task=BWS-581', 'safe_local_terminal_gate=BWS-599', 'run-autonomous-implementation.sh'],
        'AGENTS.md': ['Source-of-truth order', 'BETTING_WIN_REPO_PATH', 'backlog/bws_full_implementation.csv', 'BWS-580', 'BWS-581', 'BWS-599'],
        'docs/automation/README.md': ['current_task=BWS-581', 'safe_local_terminal_gate=BWS-599', 'Exact protected-file policy', 'blanket manual override is disabled'],
        ...
        'docs/automation/repo-profile.md': ['repo_role=surebet_strategy_application', 'current_task=BWS-581', 'safe_local_terminal_gate=BWS-599'],
        'docs/automation/paper-evaluation.md': ['current_controller_mode=single_pass_no_service', 'replacement_task=BWS-588'],
        'docs/automation/paper-autopilot.md': ['integration_task=BWS-589', 'selected_now=no', 'BWS-599'],
        'PROJECT_STATUS.md': ['program=BWS_FULL_PLATFORM_IMPLEMENTATION_V1', 'status=IMPLEMENTATION_READY', 'current_task=BWS-581', 'current_task_status=PENDING', 'safe_local_completion_gate=BWS-599'],
        'docs/repo_status_current.md': ['Standard automation status', 'run_autonomous_implementation=standardized_and_selected_for_remaining_operator_runtime', 'run_paper_autopilot=standardized_parent_pending_bws_589_and_bws_599', 'run_bugfix_autopilot=standardized_parent_for_broad_audit_and_repair'],
        'docs/MASTER_PLAN.md': ['program=BWS_FULL_PLATFORM_IMPLEMENTATION_V1', 'backlog/bws_full_implementation.csv', 'BWS-581', 'BWS-599', 'Automation operating model'],
        ...
        'docs/034_remaining_operator_runtime_implementation_program.md': ['current_task=BWS-581', 'safe_local_terminal_gate=BWS-599', 'paper evaluation=single_pass_no_service'],
