...
def main() -> None:
    ...
    required_doc_markers = {
        'README.md': ['program=BWS_B1_CROSS_VENUE_OFFLINE_FALSIFICATION_V1', 'repo_role=surebet_strategy_application', 'current_task=BWS-600', 'active_implementation_queue=none', 'safe_local_terminal_gate=BWS-599', 'bws600_current_task=BWS-600', 'docs/000_documentation_index.md', 'run-autonomous-implementation.sh'],
        'AGENTS.md': ['Source-of-truth order', 'docs/000_documentation_index.md', 'BETTING_WIN_REPO_PATH', 'backlog/bws_b1_cross_venue_implementation.csv', 'BWS-700 implementation queue `backlog/bws_b1_cross_venue_implementation.csv` is complete for dependency-ready local rows through `BWS-820`', 'BWS-600', 'BWS-900'],
        'docs/automation/README.md': ['current_task=BWS-600', 'selected_controller=run-paper-autopilot.sh', 'active_implementation_queue=none', 'safe_local_terminal_gate=BWS-599', 'docs/000_documentation_index.md', 'Exact protected-file policy', 'automation_maintenance_allowed=no', 'blanket manual override is disabled', 'repository-temp-inode-safety.md'],
        'docs/automation/PROTECTED_AUTOMATION_FILES.md': ['Exact authorization contract', 'run-autonomous-implementation.sh', 'automation_maintenance_allowed=no', 'allowed_protected_files=none', 'temp_inode_guard.sh', 'completed `BWS-700` dependency-ready local implementation state'],
        'docs/automation/repo-profile.md': ['repo_role=surebet_strategy_application', 'current_task=BWS-600', 'selected_controller=run-paper-autopilot.sh', 'active_implementation_queue=none', 'safe_local_terminal_gate=BWS-599', 'bws600_current_task=BWS-600'],
        ...
        'PROJECT_STATUS.md': ['program=BWS_B1_CROSS_VENUE_OFFLINE_FALSIFICATION_V1', 'status=B1_DEPENDENCY_READY_LOCAL_IMPLEMENTATION_COMPLETE', 'current_task=BWS-600', 'active_implementation_queue=none', 'bws600_current_task=BWS-600', 'safe_local_completion_gate=BWS-599', 'docs/000_documentation_index.md', 'selected_controller=run-paper-autopilot.sh'],
        'docs/repo_status_current.md': ['Standard automation status', 'run_autonomous_implementation=available_for_future_reviewed_source_handoff_or_unblocked_bws710', 'run_paper_autopilot=standardized_selected_for_bws600_runtime_evidence_after_bws700_local_completion', 'run_bugfix_autopilot=standardized_parent_for_broad_audit_and_repair', 'paper_runtime_env_loader=selective_root_wrapper_env', 'paper_runtime_env_precedence=explicit_process_then_dotenv_fill', 'paper_runtime_schedule=operator_approved_repo_local_manifest', 'paper_runtime_policy=enforced_api_paper_provider_disabled_execution_false', 'source_fingerprint_runtime_exclusion=enabled', 'runtime_evidence_failure_stage=bounded_redacted', 'selected_task_source=docs/automation/current-implementation-task.md', 'active_implementation_queue=none', 'post_overlay_controller=run-paper-autopilot.sh'],
        'docs/MASTER_PLAN.md': ['program=BWS_B1_CROSS_VENUE_OFFLINE_FALSIFICATION_V1', 'parent_program=BWS_FULL_PLATFORM_IMPLEMENTATION_V1', 'current_task=BWS-600', 'active_implementation_queue=none', 'docs/000_documentation_index.md', 'backlog/bws_full_implementation.csv', 'BWS-581', 'BWS-599', 'Automation operating model'],
