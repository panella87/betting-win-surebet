...
def main() -> None:
    ...
    required_doc_markers = {
        'README.md': ['program=BWS_FULL_PLATFORM_IMPLEMENTATION_V1', 'repo_role=surebet_strategy_application', 'current_task=BWS-600', 'safe_local_terminal_gate=BWS-599', 'docs/000_documentation_index.md', 'run-paper-autopilot.sh'],
        'AGENTS.md': ['Source-of-truth order', 'docs/000_documentation_index.md', 'BETTING_WIN_REPO_PATH', 'backlog/bws_full_implementation.csv', 'BWS-580', 'BWS-581', 'BWS-599'],
        'docs/automation/README.md': ['current_task=BWS-600', 'selected_controller=run-paper-autopilot.sh', 'safe_local_terminal_gate=BWS-599', 'docs/000_documentation_index.md', 'Exact protected-file policy', 'automation_maintenance_allowed=no', 'blanket manual override is disabled', 'repository-temp-inode-safety.md'],
        ...
        'docs/automation/repo-profile.md': ['repo_role=surebet_strategy_application', 'current_task=BWS-600', 'safe_local_terminal_gate=BWS-599', 'run-paper-autopilot.sh'],
        ...
        'PROJECT_STATUS.md': ['program=BWS_FULL_PLATFORM_IMPLEMENTATION_V1', 'status=RUNTIME_EVIDENCE_READY', 'current_task=BWS-600', 'current_task_status=BLOCKED_EXTERNAL_RUNTIME_EVIDENCE', 'safe_local_completion_gate=BWS-599', 'docs/000_documentation_index.md', 'selected_controller=run-paper-autopilot.sh'],
        'docs/repo_status_current.md': ['Standard automation status', 'run_autonomous_implementation=standardized_not_selected_no_known_implementation_queue', 'run_paper_autopilot=selected_for_bws600_runtime_evidence_after_upstream_api_preflight', 'run_bugfix_autopilot=standardized_parent_for_broad_audit_and_repair', 'paper_runtime_env_loader=selective_root_wrapper_env', 'paper_runtime_env_precedence=explicit_process_then_dotenv_fill', 'paper_runtime_schedule=operator_approved_repo_local_manifest', 'paper_runtime_policy=enforced_api_paper_provider_disabled_execution_false', 'source_fingerprint_runtime_exclusion=enabled', 'runtime_evidence_failure_stage=bounded_redacted', 'selected_task_source=docs/041_external_runtime_preflight_and_bws600_campaign.md'],
        'docs/MASTER_PLAN.md': ['program=BWS_FULL_PLATFORM_IMPLEMENTATION_V1', 'current_task=BWS-600', 'docs/000_documentation_index.md', 'backlog/bws_full_implementation.csv', 'BWS-581', 'BWS-599', 'Automation operating model'],
