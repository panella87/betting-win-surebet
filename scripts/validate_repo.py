...
REQUIRED = [
  ...
  'docs/009_settlement_replay_contract.md','docs/010_paper_evaluation_and_kill_criteria.md','docs/011_validation_matrix.md','docs/012_runbook.md','docs/013_autonomous_controller_status_contract.md','docs/014_sure_001_remaining_hardening_backlog.md','docs/015_local_engine_implementation_backlog.md','docs/016_pinned_betting_win_interface_readiness.md','docs/017_private_paper_mode_implementation_backlog.md','docs/018_private_paper_mode_runbook.md',
...
def main() -> None:
    ...
    for needle in ['does not own provider truth', 'Reciprocal odds alone are not acceptance evidence', 'Source-of-truth order']:
