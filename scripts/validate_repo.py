...
def main() -> None:
    ...
    required_doc_markers = {
        'README.md': ['program=BWS_FULL_PLATFORM_IMPLEMENTATION_V1', 'repo_role=surebet_strategy_application', 'current_task=BWS-592', 'safe_local_terminal_gate=BWS-599', 'run-autonomous-implementation.sh'],
        'AGENTS.md': ['Source-of-truth order', 'BETTING_WIN_REPO_PATH', 'backlog/bws_full_implementation.csv', 'BWS-580', 'BWS-581', 'BWS-599'],
        'docs/automation/README.md': ['current_task=BWS-592', 'safe_local_terminal_gate=BWS-599', 'Exact protected-file policy', 'automation_maintenance_allowed=no', 'blanket manual override is disabled'],
        ...
        'docs/automation/repo-profile.md': ['repo_role=surebet_strategy_application', 'current_task=BWS-592', 'safe_local_terminal_gate=BWS-599'],
        ...
        'PROJECT_STATUS.md': ['program=BWS_FULL_PLATFORM_IMPLEMENTATION_V1', 'status=IMPLEMENTATION_READY', 'current_task=BWS-592', 'current_task_status=PENDING', 'safe_local_completion_gate=BWS-599'],
        ...
        'docs/034_remaining_operator_runtime_implementation_program.md': ['current_task=BWS-592', 'safe_local_terminal_gate=BWS-599', 'paper evaluation=runtime_evidence_mode_validated'],
