...
def main() -> None:
    ...
    required_doc_markers = {
        ...
        'PROJECT_STATUS.md': ['program=BWS_FULL_PLATFORM_IMPLEMENTATION_V1', 'status=IMPLEMENTATION_READY', 'current_task=BWS-599', 'current_task_status=VALIDATED', 'safe_local_completion_gate=BWS-599'],
        'docs/repo_status_current.md': ['Standard automation status', 'run_autonomous_implementation=standardized_and_selected_for_remaining_operator_runtime', 'run_paper_autopilot=runtime_evidence_parent_validated_bws_589_ready_for_bws_600', 'run_bugfix_autopilot=standardized_parent_for_broad_audit_and_repair'],
