...
Schema: `../schemas/campaign-admission.schema.json`
Non-evidence example: `../examples/campaign-admission.example.json`

## Purpose

This immutable receipt records the `campaign-admission` boundary for `BWS_FINAL_REMEDIATION_R01_R12_V1`. Unknown fields are rejected. Missing required fields fail closed. Raw secrets, credentials, passwords, tokens, private keys, or protected configuration values are prohibited.
