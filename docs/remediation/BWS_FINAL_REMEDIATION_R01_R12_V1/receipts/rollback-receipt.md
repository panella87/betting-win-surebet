...
Schema: `../schemas/rollback-receipt.schema.json`
Non-evidence example: `../examples/rollback-receipt.example.json`

## Purpose

This immutable receipt records the `rollback-receipt` boundary for `BWS_FINAL_REMEDIATION_R01_R12_V1`. Unknown fields are rejected. Missing required fields fail closed. Raw secrets, credentials, passwords, tokens, private keys, or protected configuration values are prohibited.
...
- rollback_result
- unrelated_dirty_content_preserved
