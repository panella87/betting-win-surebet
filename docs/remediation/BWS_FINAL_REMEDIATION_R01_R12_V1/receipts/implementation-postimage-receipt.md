...
# implementation-postimage-receipt

Schema: `../schemas/implementation-postimage-receipt.schema.json`
Non-evidence example: `../examples/implementation-postimage-receipt.example.json`

## Purpose

This immutable receipt records the `implementation-postimage-receipt` boundary for `BWS_FINAL_REMEDIATION_R01_R12_V1`. Unknown fields are rejected. Missing required fields fail closed. Raw secrets, credentials, passwords, tokens, private keys, or protected configuration values are prohibited.
...
- campaign_order
- state
- preimage_generation_id
- postimage_generation_id
- changed_paths
- unchanged_authority_digest
- rollback_material_digest
