...
# Multi-process barriers and fencing proof
...
## Barrier-specific proof

- Prove all participants bind the same barrier/generation ID and expected participant set.
- Prove duplicate, late, stale-epoch, and missing participants fail closed.
- Prove only the current fenced owner may advance or finalize the barrier.
- Prove crash/restart reconstructs the durable barrier and does not count stale acknowledgements.
