# BWS118 Wave 02 prior-overlay lineage
...
- **baseline_archive:** `betting-win-surebet117.zip`
- **baseline_sha256:** `0d234e00d015dcab0989b47372ded516bddee9705d9021a0694916dc91a9d494`
- **overlay_filename:** `betting-win-surebet-cross-review-docs-overlay-r01-r03-wave01-rebased-0d234e00-20260911.zip`
- **overlay_sha256:** `3e7cac2faa605e946716ea2452198968e40438f0f256c9db5883a2b31863f481`
- **apply_script_filename:** `apply-betting-win-surebet-cross-review-docs-overlay-r01-r03-wave01-rebased-0d234e00-20260911.sh`
- **apply_script_sha256:** `fa49a0ed8bcbf6862dcc44d823152005e2eec3a9ff1c83aa30364789ead3b1fa`
- **declared_path_set:** `40 paths: 39 additions and docs/000_documentation_index.md replacement`
- **observed_result:** `All 40 exact overlay postimages are present in betting-win-surebet118.zip.`
- **rollback_result:** `NOT_APPLICABLE_TO_CURRENT_POSTIMAGE_PROOF`
- **current_postimage_match:** `40_OF_40_EXACT_HASH_AND_MODE_MATCH`
- **classification:** `LANDED_IN_CURRENT_REPOSITORY`
- **superseded_by:** `Wave 02 documentation overlay after successful application`

The binding prior BWS review overlay is `BWS-WAVE01-R01-R03-DOCS`, proven landed by exact current-archive postimage comparison. The wrong-repository BW attempt remains out of scope and failed before application.
