...
- Moved the paper-runtime upstream API timeout integer validation before lifecycle ownership can be touched.
- Classified IPv4-mapped loopback addresses as loopback before local-BWS API conflict checks.
